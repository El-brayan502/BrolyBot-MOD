...
mobile: MethodMobile, 
browser: opcion == '1' ? ['BrolyBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['BrolyBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './BrolyJadiBot';
if (!existsSync(subBotDirectory)) {
console.log('🚩 Broly-Bot no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'BrolySession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚩Broly conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🍭 Error al iniciar Broly-Bot: `, error))
}
})();
